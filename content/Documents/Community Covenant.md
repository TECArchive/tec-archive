...
The growth of the TEC community is directly related to the community’s ability to [REDACTED] an inclusive, welcoming, and healthy culture that people can feel proud of and delighted to adopt as their own. When people choose to participate in the TEC community, they are implicitly supporting the community’s culture, values, and norms.
...
Gravity behaves according to the TEC [graduated sanctions](https://forum.tecommons.org/t/scale-of-conflicts-graduated-sanction-guideline/234) and commits to its use with respect to all individuals.
...
The Token Engineering Commons uses the [Gardens](https://1hive.gitbook.io/gardens/) framework technology to manage the DAO configurations and allocate funds to projects that are aligned with its mission, vision and values.

On-chain decision making mechanisms are [Conviction Voting](https://forum.tecommons.org/t/conviction-voting-tl-dr/308?u=liviade) and [TaoAO Voting](https://forum.tecommons.org/t/disputable-voting-parameters-general-discussion/267). Conviction Voting should be used primarily for funds allocation. Tao VotingDisputable Voting should be used for updating parameters, bug fixes, adding new features to the DAO and/or for emergency situations such as an attack to the DAO treasury.

### Enforcement

The on-chain mechanism for enforcement will depend on the completion of [Celeste](https://1hive.gitbook.io/celeste/).
...
The TEC uses [Advice Process](https://app.gitbook.com/[REDACTED]-engineering-commons/s/tec-handbook/glossary) as its primary practice for flat decision making to empower contributors with agency to move their cultural proposals forward. Advice Process is written in the forum in the Advice Process section and promoted verbally in community calls. When a non-financial, no-code decision will likely affect a large part of the community, the use of off-chain voting and signaling tools are expected. The TEC recommends token weighted tools for off chain decision making, like [Snapshot](https://snapshot.org/#/tecommons.eth) and [Tokenlog](https://tokenlog.xyz/). A decision is considered legitimate when it respects this covenant, is promoted to the awareness of the community and its results aren’t challenged within 2 weeks.
...
TEC community spaces include the [TEC Discord](https://discord.gg/mUQvCm5Atm), [Discourse](https://forum.tecommons.org/) and [Github](https://github.com/CommonsBuild/coordination) communities. Other forums or social platforms which may emerge in the future are expected to adhere to this covenant.

### Enforcement

TEC intends to use [Gravity](https://forum.tecommons.org/t/gravity-general-process/173) and make use of its graduated sanctions in order to ensure community standards.
...
5. Promote Advice Processes regarding the implementation of [graduated sanctions](https://forum.tecommons.org/t/scale-of-conflicts-graduated-sanction-guideline/234) and commit to its use with respect to all individuals.

### Transparency

The TEC has a compromise with transparency as a cultural practice. It helps to promote trust, mutual monitoring, accountability and inclusion. Most community calls are recorded and posted on [TEC’s Youtube channel.](https://www.youtube.com/channel/UCagCOhMqMNU29rWx259-tcg) The [Transparency working group](https://forum.tecommons.org/t/transparency-working-group/197) promotes frequent [audits](https://forum.tecommons.org/t/welcome-to-the-transparency-audit-index/473) to the working groups. [Credentials management](https://docs.google.com/spreadsheets/d/1wfPGwNP7pWUx6WRCdO7HRA_GGJG_5IUGFZQ21EsUrb0/edit#gid=0) is visible and admins follow a particular [code of conduct.](https://docs.google.com/document/d/1hnwSQn4vxboxazraX2qPwa25bBBrvk3TpXsSDkXhqCM/edit)
